    ...
    com.util.setTimeout(
        function() {
            if ($p.isWFramePopup()) {
				...
				//browserPopup 에서 callbackFnStr 없을 경우 parameter 에서 가져오기 - LHC (2023-07-31) 
				callbackFnStr = com.util.isEmpty(callbackFnStr) ? gcm.data.getParameter($p, "callbackFn") : callbackFnStr;
